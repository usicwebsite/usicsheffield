    ...
    <div className="min-h-screen bg-gradient-to-b from-[#0A1219] to-[#18384D] text-white">
      ...
      <div className="py-16 relative overflow-hidden">
        <div className="container mx-auto px-4 text-center relative z-10">
          <h1 className="font-heading text-4xl md:text-6xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-white">USIC MEMBERSHIP</h1>
      ...
      <div className="container mx-auto px-4 pt-4 pb-16">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-12 text-center">What YOU get as a USIC MEMBER</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-[#0F1E2C] rounded-xl overflow-hidden shadow-lg">
              <div className="p-8">
                <h3 className="font-heading text-2xl md:text-3xl font-bold mb-4">Your personal USIC membership card</h3>
            ...
            <div className="bg-[#0F1E2C] rounded-xl overflow-hidden shadow-lg">
              <div className="p-8">
                <h3 className="font-heading text-2xl md:text-3xl font-bold mb-4">Exclusive discounts</h3>
                <p className="text-lg text-blue-100 mb-2">
            ...
            <div className="bg-[#0F1E2C] rounded-xl overflow-hidden shadow-lg">
              <div className="p-8">
                <h3 className="font-heading text-2xl md:text-3xl font-bold mb-4">Discounted access</h3>
                <p className="text-lg text-blue-100 mb-2">
            ...
            <div className="bg-[#0F1E2C] rounded-xl overflow-hidden shadow-lg">
              <div className="p-8">
                <h3 className="font-heading text-2xl md:text-3xl font-bold mb-4">Priority tickets</h3>
                <p className="text-lg text-blue-100 mb-2">
      ...
      <div className="container mx-auto px-4 pb-16">
        <div className="max-w-4xl mx-auto bg-[#0F1E2C] p-10 rounded-2xl text-center">
          <h2 className="font-heading text-3xl font-bold mb-6">Become a USIC Member</h2>
