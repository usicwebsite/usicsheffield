      ...
      <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg p-6">
        ...
        {syncResults && (
          <div className={`mt-4 p-4 rounded-lg ${syncResults.success ? 'bg-green-600/20 border border-green-500/30' : 'bg-red-600/20 border border-red-500/30'}`}>
            <div className="flex items-center gap-3">
              <div className={`shrink-0 ${syncResults.success ? 'text-green-400' : 'text-red-400'}`}>
                {syncResults.success ? (
          ...
          <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 max-w-md w-full">
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                className="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-hidden focus:ring-2 focus:ring-red-500 focus:border-transparent resize-none"
                rows={3}
              />
            </div>
